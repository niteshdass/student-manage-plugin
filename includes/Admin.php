...
class Admin {
    ...
    public function load_scripts() {
        ...
        // wp_localize_script('wpvk-student-list-script', 'ajax_ad_url', array(
    ...
    public function admin_menu() {
        ...
        if( current_user_can( $capability )  ) {
            $submenu[ $slug ][] = [ __( 'Students', 'textdomain' ), $capability, 'admin.php?page=' . $slug . '#/' ];
